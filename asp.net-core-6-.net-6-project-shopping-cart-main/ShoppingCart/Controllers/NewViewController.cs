...
namespace ShoppingCart.Controllers
{
    public class NewViewController : Controller
    {
        ...
        public NewViewController(DataContext context)
        {
            _context = context;
        }

        public async Task<IActionResult> NewView(string categorySlug = "", int p = 1)
        {
            int pageSize = 3;
            ...
            if (category == null) return RedirectToAction("NewView");
